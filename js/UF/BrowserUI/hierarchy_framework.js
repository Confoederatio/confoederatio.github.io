...
//Initialise Sidebar functions
{
  ...
  */
  window.initHierarchy = function (arg0_hierarchy_el, arg1_hierarchy_key, arg2_options) {
    ...
    if (!window.main.hierarchies[hierarchy_key])
      window.main.hierarchies[hierarchy_key] = {
    ...
    var hierarchies_obj = window.main.hierarchies;
...
//Hierarchy Context Menu UI functions
{
  /*
    ...
    arg2_options: (Object)
      global_selectors: (Boolean)
  */
  window.closeHierarchyContextMenus = function (arg0_hierarchy_el, arg1_context_menu_selectors, arg2_options) {
    //Convert from parameters
    var hierarchy_el = arg0_hierarchy_el;
...
//Sidebar UI functions
{
  ...
  */
  window.changeEntityName = function (arg0_hierarchy_key, arg1_element) {
    //Convert from parameters
  ...
  */
  window.createEntityElement = function (arg0_hierarchy_key, arg1_options) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
  ...
  /*
    ...
    Returns: (HTMLElement)
  */
  window.createGroupElement = function (arg0_hierarchy_key, arg1_layer, arg2_group_id) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
  ...
  /*
    ...
    arg0_e: (Event, Click)
  */
  window.editHierarchyElement = function (arg0_e) {
    //Convert from parameters
    var e = arg0_e;
  ...
  /*
    ...
    Returns: (String)
  */
  window.generateHierarchyGroupID = function (arg0_hierarchy_el) {
    //Convert from parameters
    var hierarchy_el = arg0_hierarchy_el;
  ...
  window.getEntityID = function (arg0_hierarchy_key, arg1_layer, arg2_entity_obj) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
    var layer = arg1_layer;
  ...
  window.getEntityInHierarchy = function (arg0_hierarchy_key, arg1_entity_id) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
  ...
  window.getEntityInLayer = function (arg0_hierarchy_key, arg1_layer, arg2_entity_id) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
    var layer = arg1_layer;
  ...
  /*
    ...
    Returns: (HTMLElement)
  */
  window.getRecursiveGroupElement = function (arg0_hierarchy_key, arg1_layer, arg2_group_id, arg3_group_el) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
    var layer = arg1_layer;
    var group_id = arg2_group_id;
  ...
  */
  window.getUngroupedEntities = function (arg0_hierarchy_key, arg1_layer) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
    var layer = arg1_layer;
  ...
  */
  window.initHierarchyLayer = function (arg0_hierarchy_key, arg1_layer, arg2_options) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
    var layer = arg1_layer;
    var options = (arg2_options) ? arg2_options : {};
  ...
  */
  window.onHierarchyDragEnd = function (arg0_event) {
    //Convert from parameters
    var e = arg0_event;
  ...
  */
  window.refreshHierarchy = function (arg0_hierarchy_el, arg1_hierarchy_key, arg2_do_not_refresh) {
    var hierarchy_el = arg0_hierarchy_el;
    var hierarchy_key = arg1_hierarchy_key;
  ...
  /*
    ...
    arg1_layer: (String)
  */
  window.selectLayer = function (arg0_hierarchy_el, arg1_layer) {
  ...
  */
  window.toggleHierarchyContextMenu = function (arg0_hierarchy_el, arg1_group_id, arg2_context_selector, arg3_function) {
    //Convert from parameters
    var hierarchy_el = arg0_hierarchy_el;
  ...
  /*
    ...
    arg2_do_not_refresh: (Boolean)
  */
  window.updateAllGroups = function (arg0_hierarchy_key, arg1_do_not_refresh) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
  ...
  */
  window.updateGroups = function (arg0_hierarchy_key, arg1_hierarchy_el, arg2_layer, arg3_do_not_refresh) {
    //Convert from parameters
    var hierarchy_key = arg0_hierarchy_key;
  ...
  */
  window.updateHierarchySelectionInformation = function (arg0_information_el, arg1_options) {
    //Convert from parameters
