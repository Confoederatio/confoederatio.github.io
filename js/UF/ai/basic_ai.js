...
//Requires AdBlockerPlugin, fetch-blob, node-fetch, child-process, puppeteer, puppeteer-extra-plugin-stealth
{
  /*
    ...
    Returns: (String)
  */
  window.getCurrentGeminiAccount = async function (arg0_browser_instance) {
  ...
  */
  window.initialiseBrowserGemini = async function (arg0_type) {
    //Convert from parameters
    var type = arg0_type;
    ...
    window.browser_instance = chrome_browser;
  ...
  window.initialiseAIRateLimits = function () {
    //Declare local instance variables
    var ai_config = window.config.ai;
    var rate_limits_obj = window.rate_limits;

    //Logic loops, 1-second logic loop
    window.ai_rate_limit_clock = setInterval(function(){
      //Fetch current_date
      var current_date = new Date().getTime();
      var time_difference = current_date - returnSafeNumber(window.last_rate_limit_reset);

      //Reset rate limit trackers once threshold is passed
      if (time_difference > ai_config.rate_limit_reset*1000) {
        window.last_rate_limit_reset = current_date;
  ...
  */
  window.processGPT = async function (arg0_input_text, arg1_options) { //[WIP] - Add ChatGPT 4o handling later
    //Convert from parameters
  ...
  //resetRateLimitTrackers() - Resets rate limit trackers over window.rate_limits.
  window.resetRateLimitTrackers = async function () {
    //Declare local instance variables
    var rate_limits_obj = window.rate_limits;
  ...
  */
  window.sendFileToBrowserGPT = async function (arg0_browser_instance, arg1_file_path, arg2_input_text, arg3_options) {
    //Convert from parameters
    var chrome_browser = arg0_browser_instance;
  ...
  */
  window.sendTextToBrowserGPT = async function (arg0_browser_instance, arg1_input_text, arg2_options) {
    //Convert from parameters
    var chrome_browser = arg0_browser_instance;
    ...
    //Declare local instance variables
    var gemini_rate_limits = window.rate_limits[options.type];
  ...
  */
  window.switchAccount = async function (arg0_browser_instance, arg1_account_name) {
    //Convert from parameters
    var chrome_browser = arg0_browser_instance;
  ...
  /*
    switchToAvailableAccount() - Switches to an available account as defined in window.config.ai.
    arg0_browser_instance: (Object, BrowserInstance)
    arg1_type: (String)
    arg2_available_accounts: (Array<String>/String)
  */
  window.switchToAvailableAccount = async function (arg0_browser_instance, arg1_type, arg2_available_accounts) { //[WIP] - Finish function body
    //Convert from parameters
    var chrome_browser = arg0_browser_instance;
