...
//Requires puppeteer, puppeteer-extra-plugin-stealth
{
  ...
  */
  window.addMarginsToScreenshot = async function (arg0_screnshot_buffer, arg1_options) {
  ...
  window.adjustSliderToMin = async function (arg0_el) {
    //Convert from parameters
  ...
  window.clickElement = async function (arg0_el) {
    //Convert from parameters
  ...
  */
  window.getBrowserInstance = async function (arg0_options) {
    //Convert from parameters
    var options = (arg0_options) ? arg0_options : {};

    //Guard clause if already connected
    if (window.browser_instance)
      if (await isPageConnected(window.browser_instance)) {
        return window.browser_instance;
      } else {
        console.log(`Page isn't connected. Restarting browser instance.`);
        delete window.browser_instance;
      }

    //Declare local instance variables
    window.browser_instance = await initialiseChrome();
  ...
  window.getPlaintextFromSelectors = async function (arg0_url, arg1_selectors) {
    //Convert from parameters
    var url = arg0_url;
  ...
  window.getWebsiteHTML = async function (arg0_url) {
    //Convert from parameters
    var url = arg0_url;
  ...
  */
  window.getWebsiteLinks = async function (arg0_url, arg1_options) {
    //Convert from parameters
    var url = arg0_url;
    var options = (arg1_options) ? arg1_options : {};
  ...
  window.getWebsitePlaintext = async function (arg0_url) {
    //Convert from parameters
    var url = arg0_url;
  ...
  /*
    ...
    Returns: (String)
  */
  window.generatePlaintext = async function (arg0_options) {
    //Convert from parameters
    var options = (arg0_options) ? arg0_options : {};
    ...
    arg0_options: (Object)
      ...
      selectors*: (Object)
        <#>: (Object) - The traversal depth at which these selector rules apply.
          ...
          scrape_iframes: (Boolean) - Optional. Whether to scrape iframe contents by fetching and loading their href. False by default.
  */
  window.generatePlaintextRecursively = async function (arg0_options) {
    //Convert from parameters
    var options = (arg0_options) ? arg0_options : {};
  ...
  window.getElement = async function (arg0_browser_instance, arg1_query_selector) {
    //Convert from parameters
  ...
  window.initialiseChrome = async function () {
    ...
    window.browser_instance = pages[0];

    //Return statement
    return pages[0];
  }

  window.isPageConnected = async function (arg0_browser_instance) {
    //Convert from parameters
  ...
  */
  window.screenshotHTML = async function (arg0_browser_instance, arg1_path, arg2_options) {
    //Convert from parameters
    var browser_instance = arg0_browser_instance;
    var path = arg1_path;
  ...
  window.stripHTML = function (arg0_html) {
    //Convert from parameters
    var html = arg0_html;
  ...
  window.waitForStableContent = async function (arg0_browser_instance, arg1_selector, arg2_interval) {
    //Convert from parameters
    var chrome_instance = arg0_browser_instance;
  ...
  window.writeTextFile = function (arg0_filepath, arg1_text) {
    //Convert from parameters
