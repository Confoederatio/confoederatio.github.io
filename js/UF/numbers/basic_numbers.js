//Initialise functions
{
  /*
    ...
    Returns: (String)
  */
  window.alphabetiseNumber = function (arg0_string) {
  ...
  /*
    ...
    Returns: (Number)
  */
  window.arabicise = function (arg0_number) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.degreesToRadians = function (arg0_degrees) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (String)
  */
  window.deordinalise = function (arg0_string) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.exp = function (arg0_number, arg1_number) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.factorial = function (arg0_number) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.generateRandomID = function (arg0_object) {
    //Convert from parameters
  ...
  window.geometricMean = function (arg0_values) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.logarithm = function (arg0_x, arg1_y) {
    //Convert from parameters
    var x = arg0_x;
    var y = arg1_y;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.logFactorial = function (arg0_number) {
    //Convert from parameters
    var number = arg0_number;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.max = function (arg0_variable) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.min = function (arg0_variable) {
    //Convert from parameters
    var list_variable = getList(arg0_variable);
  ...
  /*
    ...
    Returns: (String)
  */
  window.numeriseAlphabet = function (arg0_string) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (String)
  */
  window.oldDeordinalise = function (arg0_string) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (String)
  */
  window.ordinalise = function (arg0_number) {
    //Convert from parameters
    var i = arg0_number;
  ...
  window.parseNumber = function (arg0_number, arg1_options) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.radiansToDegrees = function (arg0_radians) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (Number)
  */
  window.randomNumber = function (arg0_min, arg1_max, arg2_do_not_round) {
    //Convert from parameters
    var min = arg0_min;
    var max = arg1_max;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.returnSafeNumber = function (arg0_operation, arg1_default) {
    //Convert from parameters
  ...
  /*
    ...
    Returns: (String)
  */
  window.romanise = function (arg0_number) {
    //Convert from parameters
    var number = arg0_number;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.root = function (arg0_number, arg1_root) {
    //Convert from parameters
    var number = arg0_number;
    var root = arg1_root;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.round = function (arg0_number, arg1_rounding_places) {
    //Convert from parameters
    var number = arg0_number;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.sigfig = function (arg0_number, arg1_sigfigs) {
    //Convert from parameters
    var number = arg0_number;
  ...
  */
  window.splitNumber = function (arg0_number, arg1_parts) {
    //Convert from parameters
    var number = arg0_number;
  ...
  window.splitNumberParts = function* (arg0_number, arg1_parts) {
    //Convert from parameters
    var number = arg0_number;
    var parts = arg1_parts;
  ...
  /*
    ...
    Returns: (Number)
  */
  window.unzero = function (arg0_number, arg1_default) {
    //Convert from parameters
    var number = returnSafeNumber(arg0_number);
  ...
  window.weightedGeometricMean = function (arg0_values) {
    //Convert from parameters
    var values = getList(arg0_values);
