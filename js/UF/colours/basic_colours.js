//Initialise functions
{
  ...
  */
  ...
  window.decodeRGBAAsNumber = function (arg0_rgba) {
  ...
  /*
    ...
    Returns: (Number)
  */
  window.deltaE = function (rgbA, rgbB) {
  ...
  */
  window.generateRandomColour = function () {
    //Return statement
  ...
  /*
    ...
    Returns: (Number)
  */
  window.getColourDistance = function (arg0_rgb, arg1_rgb) {
    //Convert from parameters
  ...
  window.encodeNumberAsRGBA = function (arg0_number) {
    //Convert from parameters
